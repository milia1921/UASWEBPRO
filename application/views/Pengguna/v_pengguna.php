                            ...
                            <tbody>
                                ...
                                foreach ($daftar_petugas as $petugas) { ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?php echo $petugas->name; ?></td>
                                        <td class="text-center"><?php echo $petugas->email; ?></td>
                                        <td class="">
                                            <div>
                                                <!-- Modal Edit -->
                                                <section class="content">
                                                    <div class="modal fade" id="modal-edit<?php echo $petugas->id ?>">
                                                                    ...
                                                                    <form name="frmpengguna" method="post" action="<?php base_url() ?>/pengguna/simpan_edit">
                                                                        <div class="card-body">
                                                                            ...
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="email" value="<?php echo $petugas->email ?>" class="form-control" id="" name="email">
                                                                            </div>
                                                                            <div class="form-group">
                                            ...
                                            <div class="text-center">
                                                ...
                                                <a data-toggle="modal" data-target="#modal-edit<?php echo $petugas->id ?>" class=" btn btn-warning edit"><i class="fa fa-edit" title="Edit"></i> </a>
                                                <a href="pengguna/hapus/<?php echo $petugas->username; ?>" onclick="return confirm('Hapus Data Petugas <?php echo $petugas->name; ?> ?')" class="btn btn-danger" title="Hapus"><i class="fa fa-trash"></i> </a>
                                            </div>
                                        </td>
                                    </tr>
                                <?php } ?>
